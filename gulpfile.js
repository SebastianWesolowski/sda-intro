...
gulp.task("copy-assets", () =>
  gulp.src(["css/assets/*"]).pipe(gulp.dest("./dist/assets"))
);
...
gulp.task(
  "default",
  gulp.series(gulp.parallel("js", "css", "copy-assets", "plugins"), "test")
);

gulp.task("build", gulp.parallel("js", "css", "copy-assets", "plugins"));
...
gulp.task("serve", () => {
  ...
  gulp.watch(
    ...
    gulp.series("css-customs", "reload")
  );
